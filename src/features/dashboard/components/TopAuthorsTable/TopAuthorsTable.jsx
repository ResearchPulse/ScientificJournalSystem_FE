...
function FieldBadge({
  ...
  return (
    <Badge pill variant="secondary" className="d-none d-sm-inline" style={{ fontSize: '0.65rem', border: '1px solid var(--border)' }}>
      {field}
    </Badge>
  );
}
  ...
  const description = loading ? <div className="p-3">
      {[1, 2, 3, 4, 5].map(i => <div key={i} className="d-flex align-items-center gap-3 py-3 px-2 border-bottom border-light">
          ...
          <div className="flex-grow-1">
            <LoadingSkeleton width="60%" height="13px" className="mb-2" />
