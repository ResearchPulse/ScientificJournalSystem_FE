        ...
        <Row className="gy-4 journal-hero-content">
          <Col lg={8}>
            <div className="d-flex gap-2 mb-3">
              ...
              <LoadingSkeleton width="100px" height="24px" borderRadius="6px" />
            </div>
            <LoadingSkeleton width="80%" height="44px" className="mb-3" />
            <LoadingSkeleton width="95%" height="64px" className="mb-4" />
            <div className="d-flex gap-2 flex-wrap">
              {[1, 2, 3].map(i => <LoadingSkeleton key={i} width="92px" height="32px" borderRadius="999px" />)}
            </div>
          </Col>
          <Col lg={4} className="text-lg-end">
            <LoadingSkeleton width="150px" height="72px" className="mb-2 ms-lg-auto" />
            <LoadingSkeleton width="160px" height="20px" className="mb-3 ms-lg-auto" />
            <div className="d-flex gap-2 justify-content-lg-end flex-wrap">
              <LoadingSkeleton width="110px" height="38px" borderRadius="6px" />
              <LoadingSkeleton width="140px" height="38px" borderRadius="6px" />
            </div>
          </Col>
        </Row>
      </section>;
