    ...
    <div className="article-list-page grid-bg">
      ...
      <Container className="article-list-shell">
        ...
        >
          <div>
            <div className="article-list-eyebrow">
              ...
              HyperData Lab Articles
            </div>
            <h1 id="article-list-title" className="article-list-title">
              {t("article.khoLuuTruBaiBaoKhoaHoc")}
            </h1>
            <p className="article-list-description">
              {t("article.duyetQuaTimKiemVaLocHangNghinB")}
            </p>
            ...
            {filters.selectedVolume && (
              <div className="article-list-scope">
                ...
                <span>
                  {t("article.dangXemBaiBaoThuocVolume")}
                  {filters.selectedVolume}
                </span>
              </div>
            )}
            {filters.selectedIssue && (
              <div className="article-list-scope">
                ...
                <span>
                  {t("article.dangXemBaiBaoThuocIssue")}
                  {filters.selectedIssue}
                </span>
              </div>
            )}
          ...
          <aside className="article-list-summary" aria-label="Tổng kết bài báo">
            <div className="article-list-summary__label">
              {t("article.tongKetQua")}
            </div>
        ...
        <div className="d-flex align-items-center justify-content-between mb-3 flex-wrap gap-2">
          <div className="text-muted-custom text-xs">
            ...
            <span className="text-main font-weight-bold">
              {articles.length}
            </span>{" "}
            {t("pagination.of", "of")}{" "}
            <span className="text-main font-weight-bold">
      ...
      >
        <Modal.Body className="p-4 text-center">
          ...
          <h4 className="font-display font-weight-bold mb-3 text-main">
            {t("article.yeuCauDangNhap")}
          </h4>
          <p
            className="text-muted-custom text-sm mb-4"
            style={{
              lineHeight: "1.6",
            }}
          >
            {t("article.deXemToanBoNoiDungChiTietBaiBa")}
          </p>
