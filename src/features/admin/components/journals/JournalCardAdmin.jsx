      ...
      >
        <Card.Body className="d-flex flex-column p-4 text-start">
          <div className="d-flex justify-content-between align-items-center mb-3">
            <span className="text-muted-custom small fw-semibold font-monospace">
              {displayId}
            </span>
          ...
          >
            <Row className="g-2">
              <Col
                xs={6}
                className="border-end border-bottom pb-1.5"
                style={{
                  borderColor: "var(--border)",
                }}
              >
                <span
                  className="text-muted-custom text-xs d-block text-uppercase fw-semibold"
                  style={{
                    fontSize: "0.65rem",
                  }}
                >
                ...
                <span className="text-main fw-bold text-truncate d-block">
                  {journal.publisher || "HyperData Lab"}
                </span>
              </Col>
              <Col
                xs={6}
                className="ps-3 border-bottom pb-1.5"
                style={{
                  borderColor: "var(--border)",
                }}
              >
                ...
                <span className="text-main fw-bold d-block">
                  {journal.type || "Journal"}
                </span>
              </Col>
              <Col
                xs={6}
                className="border-end pt-1.5"
                style={{
                  borderColor: "var(--border)",
                }}
              >
          ...
          <div
            className="d-flex align-items-center gap-2.5 bg-light p-2.5 rounded-3 mb-4 mt-auto"
            style={{
              backgroundColor: "var(--bg-chip)",
            }}
          >
            ...
            <div className="text-truncate">
              <span
                className="fw-bold text-main d-block text-truncate"
                style={{
                  fontSize: "0.85rem",
                }}
              >
              ...
              <span
                className="text-muted-custom text-xs text-uppercase fw-semibold"
                style={{
                  fontSize: "0.65rem",
          ...
          <div
            className="d-flex justify-content-between align-items-center pt-3 border-top w-100"
            style={{
              borderColor: "var(--border)",
            }}
          >
            <div className="d-flex align-items-center gap-1.5">
              ...
              <span
                className="fw-bold text-uppercase text-main"
                style={{
                  fontSize: "0.75rem",
                }}
              >
