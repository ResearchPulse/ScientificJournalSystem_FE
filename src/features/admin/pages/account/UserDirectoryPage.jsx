...
const getApiErrorMessage = (error) => {
  ...
  return (
    error.response?.data?.message || t("admin.khongTheTaiDanhSachNguoiDung")
  );
};
    ...
    <div className="container-fluid py-2">
      ...
      <div className="d-flex flex-column flex-md-row justify-content-between align-items-md-start gap-3 mb-4">
        <div>
          ...
          <p
            className="text-muted-custom small mb-0"
            style={{
              maxWidth: "680px",
            }}
          >
            Manage platform contributors, their access levels, and account
            status within the HyperData Lab ecosystem.
          </p>
        </div>
      ...
      <Row className="g-4">
        ...
        <Col xs={12} lg={8.5} className="col-lg-8">
          <Card className="p-4 rounded-4 border bg-white shadow-sm">
            ...
            {loading ? (
              <div className="text-center py-5 text-muted-custom small">
                {t("admin.dangTaiDanhSachNguoiDung")}
              </div>
            ) : error ? (
              <div className="text-center py-5 border rounded-3 bg-white">
                <Icon
                  ...
                  width="48"
                  className="text-danger mb-2 opacity-75"
                />
                <h6 className="text-main fw-bold">
                  {t("admin.khongTheTaiNguoiDung")}
                </h6>
              ...
              <UserTable
                users={users}
                onEdit={(id) =>
                  navigate(ROUTES.ADMIN_USERS_EDIT.replace(":id", id))
                }
        ...
        <Col xs={12} lg={3.5} className="col-lg-4 d-flex flex-column gap-4">
          ...
          >
            ...
            <p className="mb-4 text-white-50 small lh-sm">
              Review system permissions and security logs for auditing purposes.
              Maintain strict compliance across all journal volumes.
            </p>
            <a
              href="#security"
              onClick={(e) => {
          ...
          <Card className="p-4 rounded-4 border bg-white shadow-sm">
            <div className="d-flex align-items-center justify-content-between mb-3.5">
              <div className="d-flex align-items-center gap-2">
                <h6
                  className="fw-bold text-main mb-0"
                  style={{
                    fontSize: "0.925rem",
                  }}
                >
            ...
            <div className="text-center py-4 text-muted-custom small">
              <Icon
                ...
                width="32"
                className="admin-accent-text mb-2 opacity-50"
              />
          ...
          <Card className="p-4 rounded-4 border bg-white shadow-sm">
            <h6
              className="fw-bold text-main mb-3 text-uppercase tracking-wider"
              style={{
                fontSize: "0.78rem",
              }}
            >
            ...
            <div className="mb-3.5">
              <div
                className="d-flex justify-content-between small text-muted-custom mb-1.5"
                style={{
                  fontSize: "0.825rem",
                }}
              >
